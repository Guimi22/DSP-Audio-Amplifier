...
set_property PACKAGE_PIN B13 [get_ports SCLK]					
	set_property IOSTANDARD LVCMOS33 [get_ports SCLK]
#Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports SD]					
	set_property IOSTANDARD LVCMOS33 [get_ports SD]
#Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports WS]					
	set_property IOSTANDARD LVCMOS33 [get_ports WS]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = JA4
#set_property PACKAGE_PIN E17 [get_ports Debug_sample]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Debug_sample]
##Bank = 15, Pin name = IO_0_15,								Sch name = JA7
#set_property PACKAGE_PIN G13 [get_ports Sample_output[15]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[15]]
##Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = JA8
#set_property PACKAGE_PIN C17 [get_ports ampPWM]					
#	set_property IOSTANDARD LVCMOS33 [get_ports ampPWM]
##Bank = 15, Pin name = IO_L21N_T3_A17_15,					Sch name = JA9
#set_property PACKAGE_PIN D18 [get_ports Sample_output[13]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[13]]
##Bank = 15, Pin name = IO_L21P_T3_DQS_15,					Sch name = JA10
#set_property PACKAGE_PIN E18 [get_ports Sample_output[12]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[12]]



##Pmod Header JB
##Bank = 15, Pin name = IO_L15N_T2_DQS_ADV_B_15,				Sch name = JB1
#set_property PACKAGE_PIN G14 [get_ports ampPWM]					
#	set_property IOSTANDARD LVCMOS33 [get_ports ampPWM]
##Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = JB2
#set_property PACKAGE_PIN P15 [get_ports Sample_output[10]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[10]]
#Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
#set_property PACKAGE_PIN V11 [get_ports outPDM]					
#	set_property IOSTANDARD LVCMOS33 [get_ports outPDM]
#Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = JB4
#set_property PACKAGE_PIN V15 [get_ports Sample_output[8]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[8]]
##Bank = 15, Pin name = IO_25_15,							Sch name = JB7
#set_property PACKAGE_PIN K16 [get_ports Sample_output[7]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[7]]
##Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = JB8
#set_property PACKAGE_PIN R16 [get_ports Sample_output[6]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[6]]
##Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = JB9
#set_property PACKAGE_PIN T9 [get_ports Sample_output[5]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[5]]
##Bank = 14, Pin name = IO_L19N_T3_A09_D25_VREF_14,			Sch name = JB10 
#set_property PACKAGE_PIN U11 [get_ports Sample_output[4]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[4]]
 


##Pmod Header JC
##Bank = 35, Pin name = IO_L23P_T3_35,						Sch name = JC1
#set_property PACKAGE_PIN K2 [get_ports Sample_output[3]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[3]]
##Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
#set_property PACKAGE_PIN E7 [get_ports Sample_output[2]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[2]]
##Bank = 35, Pin name = IO_L22P_T3_35,						Sch name = JC3
#set_property PACKAGE_PIN J3 [get_ports Sample_output[1]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[1]]
##Bank = 35, Pin name = IO_L21P_T3_DQS_35,					Sch name = JC4
#set_property PACKAGE_PIN J4 [get_ports Sample_output[0]]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Sample_output[0]]
##Bank = 35, Pin name = IO_L23N_T3_35,						Sch name = JC7
#set_property PACKAGE_PIN K1 [get_ports word_count_flag]					
#	set_property IOSTANDARD LVCMOS33 [get_ports word_count_flag]
##Bank = 35, Pin name = IO_L5P_T0_AD13P_35,					Sch name = JC8
#set_property PACKAGE_PIN E6 [get_ports WS_flag]					
#	set_property IOSTANDARD LVCMOS33 [get_ports WS_flag]
##Bank = 35, Pin name = IO_L22N_T3_35,						Sch name = JC9
#set_property PACKAGE_PIN J2 [get_ports sclk_flag]					
#	set_property IOSTANDARD LVCMOS33 [get_ports sclk_flag]
##Bank = 35, Pin name = IO_L19P_T3_35,						Sch name = JC10
#set_property PACKAGE_PIN G6 [get_ports clk_fpga]					
...
#set_property PACKAGE_PIN H4 [get_ports sclk_in_dbg]					
#	set_property IOSTANDARD LVCMOS33 [get_ports sclk_in_dbg]
##Bank = 35, Pin name = IO_L17P_T2_35,						Sch name = JD2
#set_property PACKAGE_PIN H1 [get_ports ws_in_dbg]					
#	set_property IOSTANDARD LVCMOS33 [get_ports ws_in_dbg]
##Bank = 35, Pin name = IO_L17N_T2_35,						Sch name = JD3
#set_property PACKAGE_PIN G1 [get_ports Data_in_dbg]					
#	set_property IOSTANDARD LVCMOS33 [get_ports Data_in_dbg]
##Bank = 35, Pin name = IO_L20N_T3_35,						Sch name = JD4
#set_property PACKAGE_PIN G3 [get_ports reset_fpga]					
#	set_property IOSTANDARD LVCMOS33 [get_ports reset_fpga]
##Bank = 35, Pin name = IO_L15P_T2_DQS_35,					Sch name = JD7
#set_property PACKAGE_PIN H2 [get_ports PWM_Output]					
#	set_property IOSTANDARD LVCMOS33 [get_ports PWM_Output]
##Bank = 35, Pin name = IO_L20P_T3_35,						Sch name = JD8
#set_property PACKAGE_PIN G4 [get_ports SD_ampout]					
#	set_property IOSTANDARD LVCMOS33 [get_ports SD_ampout]
...
#set_property PACKAGE_PIN B7 [get_ports {ampPWM[0]}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {ampPWM[0]}]
##Bank = 35, Pin name = IO_L4N_T0_35,						Sch name = VGA_B1
#set_property PACKAGE_PIN C7 [get_ports {ampPWM[1]}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {ampPWM[1]}]
##Bank = 35, Pin name = IO_L6N_T0_VREF_35,					Sch name = VGA_B2
#set_property PACKAGE_PIN D7 [get_ports {ampPWM[2]}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {ampPWM[2]}]
##Bank = 35, Pin name = IO_L4P_T0_35,						Sch name = VGA_B3
#set_property PACKAGE_PIN D8 [get_ports {ampPWM[3]}]				
#	set_property IOSTANDARD LVCMOS33 [get_ports {ampPWM[3]}]
...
set_property PACKAGE_PIN A11 [get_ports ampPDM]					
	set_property IOSTANDARD LVCMOS33 [get_ports ampPDM]
